...
// jLabel2;
jLabel2 = new JLabel("Enter room number: ");
...
// jButtonDeletRoom;
jButtonDeletRoom = new JButton("Delet room");
jButtonDeletRoom. setBounds(50 , 170 , 120 , 30 ) ;
contentPane.add(jButtonDeletRoom );
jButtonDeletRoom.addActionListener(this);
//JButton jButtonBack;
...
if( event.getSource().equals((JButton) jButtonDeletRoom)){
...
if( event.getSource().equals((JButton) jButtonBack)){
...
if( event.getSource().equals((JButton) jButtonView)){
TextArea1.setText("");
 Reservation[] list = TestHotel.hotel.reservations ;
 int count = 0;
